document.addEventListener('DOMContentLoaded', () => {
    ...
    const contractAddress = "0x6d3a8fd5cf89f9a429bfadfd970968f646aff325"; // <-- THIS IS THE ADDRESS YOU PROVIDED.
    ...
    // The contract's ABI (I have pasted the correct one for you below).
    ...
    async function findArchivers() {
        ...
        try {
            ...
            // This filter works best because 'subject' is an indexed topic in the event.
